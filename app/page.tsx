...
export default function Home() {
  return <>
    ...
    <header className="nav wrap">
      <a href="/" className="wordmark" aria-label="Chen home">chen<Asterisk size={20} /></a>
    ...
    <main id="main">
      ...
      <section id="writing" className="wrap writing section">
        ...
        <div className="post-list">{posts.map((post,index)=><a className="post-row" href={`/writing/${post.slug}`} key={post.slug}>
      ...
      <section id="contact" className="wrap section contact">
        ...
        <div className="contact-bottom"><p>I help teams find a useful starting point for AI,<br className="desktop-break"/> shape agent workflows, and decide what good looks like.</p><a className="contact-link" href="/contact">Let's talk <ArrowUpRight size={32}/></a></div>
