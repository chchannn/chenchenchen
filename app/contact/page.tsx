...
export default function Contact() {
  return <>
    ...
    <main className="inquiry wrap">
      <div className="inquiry-intro"><span className="small">WORK TOGETHER</span><h1>Let's talk<span>.</span></h1><p>What are you working on?</p><p>Tell me about your team, the problem you're exploring, and where you could use a hand.</p><a className="email-link" href="mailto:leave117@gmail.com">leave117@gmail.com</a></div>
      <ContactForm/>
    </main>
